...
<div class="center-header_div d-flex justify-content-between align-items-center w-100">

    <div class="menu_content_left">
        <div class="dropdown">
            <button class="dropbtn"><i class="fa-solid fa-bars"></i> Danh mục sản phẩm</button>
        </div>
    </div>

    <div class="menu_content_right d-flex align-items-center">

        <a href="${pageContext.request.contextPath}/voucher" class="btn-voucher mr-4">
            <i class="fa-solid fa-ticket"></i> Săn mã giảm giá
        </a>

        <div class="hotline d-flex align-items-center">
            <a href="tel:0867415853" class="d-flex align-items-center text-dark" style="text-decoration: none;">
                <i class="fa-solid fa-phone mr-1"></i>
                <h4 class="mb-0ist" style="font-size: 14px; display: inline;">Hotline: </h4>
                <span class="font-weight-bold text-primary ml-1">0867 415 853</span>
            </a>
        </div>
